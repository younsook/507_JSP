...
<%!
public String useImplictioObject(){
	return this.getServletContext().getRealPath("/02ImplicitObject");
}
public String useImplictioObject(ServletContext app){
	return app.getRealPath("/02ImplicitObject");
}
%>
<ul>
	<li>this 사용 : <%= useImplictioObject() %></li>
	<li>내장 객체를 인수로 전달 : <%= useImplictioObject(application)%></li>
</ul>
